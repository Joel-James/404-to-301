 ...
 * @var DuckDev\FourNotFour\Settings $settings Settings class.
 *
...
<div
	...
	class="duckdev-fields <?php echo 'page' !== duckdev_404_to_301_settings()->get( 'redirect_target', 'link' ) ? 'duckdev-hidden' : ''; ?>"
>
	<p>
