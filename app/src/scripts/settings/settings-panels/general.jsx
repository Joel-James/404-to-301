			...
			>
				<PanelRow>
					<ToggleControl
						...
						onChange={(checked) => this.updateValue('disable_guessing', checked)}
					/>
				</PanelRow>
				...
				<PanelRow>
					<ToggleControl
						...
						onChange={(checked) => this.updateValue('monitor_changes', checked)}
					/>
				</PanelRow>
				...
				<PanelRow>
					<ToggleControl
						...
						onChange={(checked) => this.updateValue('ip_logging', checked)}
					/>
				</PanelRow>
