			...
			>
				<PanelRow>
					<ToggleControl
						...
						help={__('Do you want to redirect the 404 errors to a new page or URL?', '404-to-301')}
						onChange={(checked) => this.updateValue('redirect_enabled', checked)}
					/>
				</PanelRow>
				...
				<PanelRow>
					<RadioControl
						...
						help={__('From the target types, choose where you want to redirect the 404 errors to.', '4045-to-301')}
						selected={settings.redirect_target}
						options={[
							{label: __('Page', '404-to-301'), value: 'page'},
							{label: __('Link', '404-to-301'), value: 'link'}
						]}
						onChange={(selected) => this.updateValue('redirect_target', selected)}
					/>
				</PanelRow>
				...
				{settings.redirect_target === 'page' ?
					<PanelRow>
						<SelectControl
							...
							onChange={(selected) => this.updateValue('redirect_page', selected)}
						/>
					</PanelRow>
					:
					<PanelRow>
