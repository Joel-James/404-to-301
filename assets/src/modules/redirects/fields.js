...
import { Truncate, redirectTypes, terminalStatusCodes } from '../../common'

// The redirect/error status catalogue (and its terminal subset) now
// comes from the shared, PHP-localised source in
// `common/redirect-statuses.js`. Re-exported here so the existing
// importers in this module (`form-fields.js`, the edit modal, …) keep
// resolving them from `./fields` unchanged.
export { redirectTypes, terminalStatusCodes }
