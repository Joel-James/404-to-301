 ...
 * @since   4.0.0
 * @extends Base
 * @package DuckDev\FourNotFour\Controllers
 */
class Settings extends Base {
	...
	public function get( $key, $default = false, &$valid = true ) {
		 ...
		 */
		return apply_filters( '404_to_301_settings_get', $value, $key, $default, $valid );
	}
	...
	public function all( $use_default = false ) {
		 ...
		 */
		return apply_filters( '404_to_301_settings_all', $settings, $use_default );
	}
	...
	public function update( array $values ) {
		 ...
		 */
		$values = apply_filters( '404_to_301_settings_pre_update', $values );
	...
	public function defaults() {
		 ...
		 * @param array $settings Settings.
		 */
		return apply_filters( '404_to_301_settings_defaults', $settings );
	}
	...
	private function format_values( array $values ) {
		 ...
		 */
		return apply_filters( '404_to_301_settings_format_values', $processed, $values );
	}
