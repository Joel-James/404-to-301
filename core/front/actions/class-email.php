...
class Email extends Action {
	...
	private function notify() {
		 ...
		 */
		do_action( '404_to_301_before_email', $recipient, $subject, $body, $headers, $this->request );
		 ...
		 * @param Request         $request   Request object.
		 */
		do_action( '404_to_301_after_email', $success, $recipient, $subject, $body, $headers, $this->request );
	}

	/**
	 * Get email recipient address.
	 *
	 * Use `404_to_301_email_get_recipient` filter to modify the email recipient.
	 *
	 * @since  4.0.0
	 * @access private
	 * @return string
	...
	private function get_recipient() {
		...
		$recipient = duckdev_404_to_301_settings()->get(
			'email_recipient',
		 ...
		 * @param Request         $request   Request object.
		 */
		return apply_filters( '404_to_301_email_get_recipient', $recipient, $this->request );
	}

	/**
	 * Get the email subject.
	 *
	 * Use `404_to_301_email_get_subject` filter to modify the email subject.
	 *
	 * @since  4.0.0
	 * @access private
	 * @return string
	...
	private function get_subject() {
		 ...
		 * @param Request $request Request object.
		 */
		return apply_filters( '404_to_301_email_get_subject', $subject, $this->request );
	}

	/**
	 * Get the email headers.
	 *
	 * Use `404_to_301_email_get_headers` filter to modify the email headers.
	 *
	 * @since  4.0.0
	 * @access private
	 * @return array
	...
	private function get_headers() {
		 ...
		 */
		$name = apply_filters( '404_to_301_email_get_headers_name', get_bloginfo( 'name' ) );
		 ...
		 */
		$from = apply_filters( '404_to_301_email_get_headers_from', get_option( 'admin_email' ) );
		 ...
		 * @param Request $request Request object.
		 */
		return apply_filters( '404_to_301_email_get_headers', $headers, $this->request );
	}

	/**
	 * Get the email body.
	 *
	 * Use `404_to_301_email_get_body` filter to modify the email body.
	 *
	 * @since  4.0.0
	 * @access private
	 * @return string
	...
	private function get_body() {
		 ...
		 * @param Request $request Request object.
		 */
		return apply_filters( '404_to_301_email_get_body', $body, $this->request );
	}
}
