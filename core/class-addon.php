...
class Addon {
	...
	public function is_active( $id ) {
		 ...
		 */
		return apply_filters( '404_to_301_addon_is_active', $active );
	}
	...
	public function is_installed( $id ) {
		 ...
		 */
		return apply_filters( '404_to_301_addon_is_installed', $installed );
	}
	...
	public function get_addons() {
		 ...
		 */
		return apply_filters( '404_to_301_get_addons', $addons );
	}
}
