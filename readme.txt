...
> - Will not irritate your visitors if they land on an non-existing page/url.<br />
...
Bug reports for 404 to 301 are always welcome. [Report here](http://iscode.co/bugs/). Please _do not_ send support requests here.
...
- Other [WordPress plugins](https://profiles.wordpress.org/is_code/#content-plugins) by [is_code()](https://iscode.co/)
...
= Missing something? =
If you would like to have an additional feature for this plugin, [let me know](http://iscode.co/contact/)

== Frequently Asked Questions ==

= What is the use of 404 to 301? =

It will increase your SEO by redirecting all 404 errors.
...
Bug reports for 404 to 301 are always welcome. [Report here](https://iscode.co/bugs/). Please _do not_ send support requests here.
