...
class Settings {
	 ...
	 * @since 4.0
	 */
	private static $settings_key = 'dd404_settings';
	...
	public static function get_options( $group = '' ) {
		 ...
		 * @since 4.0
		 */
		$options = apply_filters( 'dd404_get_options', $options );
	...
	public static function update_option( $key, $value, $group ) {
		 ...
		 * @since 4.0
		 */
		$value = apply_filters( 'dd404_update_option', $value, $key, $group );
	...
	private static function update_options( $values ) {
		 ...
		 * @since 4.0
		 */
		$values = apply_filters( 'dd404_update_options', $values );
