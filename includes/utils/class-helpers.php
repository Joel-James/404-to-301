...
class Helpers {
	 ...
	 *
	 * The set mirrors the redirect codes other plugins (Redirection by
	 * John Godley, 301 Redirects – Redirect Manager by WebFactory)
	 * export, so imported rows map across cleanly.
	 *
