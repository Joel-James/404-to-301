    ...
    $(function () {
        ...
        $(".jj4t3_redirect_thickbox").on("click", function () {
            ...
            $.post(ajaxurl, data, function (response) {
                ...
                tb_show(jj4t3strings.redirect, "#TB_inline?width=700&height=550&inlineId=jj4t3-redirect-modal");
		...
		$("input[name='jj4t3_custom_redirect_redirect'][value="+response.redirect+"]").attr("checked", true);
		$("input[name='jj4t3_custom_redirect_log'][value="+response.log+"]").attr("checked", true);
		$("input[name='jj4t3_custom_redirect_alert'][value="+response.alert+"]").attr("checked", true);
            });
        });
