				...
				<div class="meta-box-sortables ui-sortable">
						...
						<div class="inside">
							<div class="main">
								<ul>
									...
									<li><label><?php _e( 'Author', JJ4T3_DOMAIN ); ?> : <a href="https://duckdev.com/" class="i4t3-author-link" target="_blank" title="<?php _e( 'Visit author website', JJ4T3_DOMAIN ); ?>">Joel James</a></label></li>
									<li><label><a href="https://duckdev.com/docs/docs/category/404-to-301/" class="i4t3-author-link" target="_blank" title="<?php _e( 'Visit plugin website', JJ4T3_DOMAIN ); ?>"><strong><?php _e( 'Plugin documentation', JJ4T3_DOMAIN ); ?></strong></a></label></li>
									...
									<li><label><?php _e( 'Need help?', JJ4T3_DOMAIN ); ?></label> <strong><a href="https://duckdev.com/contact/"><?php _e( 'Contact support', JJ4T3_DOMAIN ); ?></a></strong></li>
								</ul>
							</div>
						</div>
					</div>
					<div class="postbox ">
						...
						<div class="inside">
							<div class="main">
								<ul>
									<li><label><span class="dashicons dashicons-star-filled"></span> <strong><a href="https://goo.gl/SojyKC" target="_blank" title="<?php _e( 'Rate now', JJ4T3_DOMAIN ); ?>"><?php _e( 'Rate this on WordPress', JJ4T3_DOMAIN ); ?></a></strong></label></li>
									...
									<li><label><span class="dashicons dashicons-admin-plugins"></span> <strong><a href="http://goo.gl/EjWGGS" target="_blank" title="<?php _e( 'Contribute now', JJ4T3_DOMAIN ); ?>"><?php _e( 'Contribute to the Plugin', JJ4T3_DOMAIN ); ?></a></strong></label></li>
					...
					<div class="postbox ">
						...
						<div class="inside">
							<div class="main">
								...
								<p><?php printf( __( 'This plugin was developed and is maintained by <a href="%s" class="i4t3-author-link"><strong>Joel James</strong></a>, from <a href="%s">God\'s own country - Kerala, India</a>.', JJ4T3_DOMAIN ), 'https://duckdev.com/', 'https://goo.gl/6mpFYf' ); ?></p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="postbox ">
						...
						<div class="inside">
							<div class="main">
								...
								<p><a class="i4t3-author-link" href="https://goo.gl/t5g4hK" target="_blank"><span class="dashicons dashicons-external"></span> <?php _e( 'See More Details', JJ4T3_DOMAIN ); ?></a></p>
							</div>
						</div>
					</div>
				</div>
